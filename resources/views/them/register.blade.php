...
@include('them.partials.hero',['title' => 'Register'])
  ...
  <section class="section-margin--small section-margin">
    <div class="container">
      <div class="row">
        <div class="col-12">
          <form class="form-contact contact_form" method="POST" action="{{ route('register.post') }}" id="contactForm" novalidate="novalidate">
            @csrf
            <div class="row">
              <div class="col-6">
            ...
            <div class="form-group text-center text-md-right mt-3">
              <a href="{{ route('login') }}" class="btn btn-sm btn-warning">Already Register?</a>
