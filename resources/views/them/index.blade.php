        ...
        <div class="owl-carousel owl-theme blog-slider">
          @foreach ($sliderBlogs as $blog )
            ...
            <div class="blog__slide__img">
              <img class="card-img rounded-0" src="{{ asset("storage/blogs/$blog->image") }}" height="150px" alt="">
            </div>
            <div class="blog__slide__content">
              <a class="blog__slide__label" href="{{route('them.category',['id' => $blog->category->id]) }}">{{ $blog->category->name  }}</a>
